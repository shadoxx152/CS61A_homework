...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        symbol, expr = bindings.first.first, bindings.first.rest.first
...
def do_mu_form(expressions, env):
    ...
    # BEGIN PROBLEM 11
    "*** YOUR CODE HERE ***"
    validate_type(expressions.first, scheme_listp, 0, 'mu')
    validate_type(expressions.rest, scheme_listp, 1, 'mu')
