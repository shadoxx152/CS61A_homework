...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_of_city_a = distance(position, city_a)
    distance_of_city_b = distance(position, city_b)
    return get_name(city_a) if distance_of_city_a < distance_of_city_b else get_name(city_b)
