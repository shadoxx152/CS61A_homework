...
def floor_div(args):
    ...
    """
    "*** YOUR CODE HERE ***"
    current_part = args.rest
    inital_data = calc_eval(args.first)

    while current_part is not nil:
        inital_data //= calc_eval(current_part.first)
        current_part = current_part.rest
...
def eval_and(expressions):
    ...
    first_value = calc_eval(expressions.first)
